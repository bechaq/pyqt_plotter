class PlotConfig:
    def __init__(self):
        ...
        self.zticksN = 6  # number of ticks or None, used in 3D mode
        self.subplots = False  # number of subplots
        self.subplot_layout = (1, 1)  # (rows, cols) if subplots is True
        self.shared_x = False
        self.shared_y = False
        
        self.subplots_config = {}  # idx -> dict with keys: xlabel,ylabel,xlim,ylim,xticksN,yticksN,zticksN
